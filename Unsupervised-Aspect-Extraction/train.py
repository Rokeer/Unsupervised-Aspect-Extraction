...
parser.add_argument("--emb", dest="emb_path", type=str, metavar='<str>', default="datasets/preprocessed_data/restaurant/w2v_embedding", help="The path to the word embeddings file")
