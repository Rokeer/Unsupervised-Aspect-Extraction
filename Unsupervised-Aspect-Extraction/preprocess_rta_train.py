...
def preprocess_train(domain):
    f = np.load('datasets/'+domain+'/train.npy')
...
def preprocess_test(domain):
    ...
    out1 = codecs.open('datasets/preprocessed_data/'+domain+'/test.txt', 'w', 'utf-8')
    out2 = codecs.open('datasets/preprocessed_data/'+domain+'/test_label.txt', 'w', 'utf-8')
